...
public class Star implements Movable{
    ...
    public Star() {
        ...
        center = new Point(Game_new.R.nextInt(Game_new.DIM.width), Game_new.R.nextInt(Game_new.DIM.height));
        int bright = Game_new.R.nextInt(226); //Stars are muted at max brightness of 225 out of 255
