...
import edu.uchicago.gerber._08final.mvc.model.Fish;
...
@Data
public class CommandCenter_new {
	...
	//singleton
	private static CommandCenter_new instance = null;

	// Constructor made private
	private CommandCenter_new() {}

    //this class maintains game state - make this a singleton.
	public static CommandCenter_new getInstance(){
		if (instance == null){
			instance = new CommandCenter_new();
		}
		return instance;
	}
	...
	public void initGame(){
		...
		setNumFishes(6);
		fish.decrementFishNumAndSpawn();
		//add the falcon to the movFriends list
		opsQueue.enqueue(fish, GameOp.Action.ADD);
